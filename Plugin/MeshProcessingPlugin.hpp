 ...
 */
class MeshProcessingPlugin_API MeshProcessingPlugin : public QObject, Ra::Plugins::RadiumPluginInterface
{
    Q_OBJECT
  ...
  public:
    ...
    void
    addRenderers( std::vector<std::shared_ptr<Ra::Engine::Rendering::Renderer>>*  ) override {}


    virtual bool doAddFileLoader() { return false; }
    virtual void
    addFileLoaders( std::vector<std::shared_ptr<Ra::Core::Asset::FileLoaderInterface>>* ) {}
